...
```
- 사전에서 뒤에 나오는 문자열을 판별할 함수 GetLatterString 선언 (매개변수를 객체포인터로 선언)
...
```
- GetLatterString 함수를 호출하여 반환된 결과 문자열을 res에 저장 (매개변수가 포인터이므로 인자는 주소로 전달)
...
# 실행결과
<img width="975" height="236" alt="image" src="https://github.com/user-attachments/assets/778d637b-6adc-4dab-bbd0-6b015181c7ff" />

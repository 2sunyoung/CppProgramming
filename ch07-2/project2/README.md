...
```cpp
	res.real = (this->real * op2.real) - (this->img * op2.img);
```
- 곱셈한 결과를 res의 실수부 변수에 저장

```cpp
	res.img = (this->real * op2.img) + (this->img * op2.real);
```
- 곱셈한 결과를 res의 허수부 변수에 저장
...
# 실행결과
<img width="585" height="130" alt="image" src="https://github.com/user-attachments/assets/8d74e27a-ac8a-41dc-ae7e-abb5ba5f8e04" />

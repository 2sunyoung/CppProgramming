...
```
- 구의 부피를 리턴하는 멤버 함수 getArea 선언 및 정의

```cpp
Sphere::Sphere() : Sphere(1) {}
```
- Sphere()이 타겟 생성자에게 초기화를 위임하여 r=1로 설정
...
```cpp
	Sphere sph1;
```
- Sphere 클래스형 변수(객체) sph1 생성, 인자값이 없기 때문에 Sphere()이 실행됨 (r=1)
...
# 실행결과
<img width="789" height="217" alt="image" src="https://github.com/user-attachments/assets/f41c4dd1-9853-4482-88fc-2ad8cf71886f" />

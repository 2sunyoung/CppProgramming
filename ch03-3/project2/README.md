...
```cpp
	Triangle tri1;
```
- Triangle 클래스형 변수(객체) tri1 생성, 인자값이 없기 때문에 Triangle()이 실행됨 (s=1, h=1, 생성 메시지 출력)
...
```cpp
	Triangle tri2(2, 4);
```
- Triangle 클래스형 변수(객체) tri2 생성, 매개 변수가 있는 생성자가 실행됨 (s=2, h=4, 생성 메시지 출력)
...
# 실행결과
<img width="576" height="243" alt="image" src="https://github.com/user-attachments/assets/481c9f6f-d90d-467f-b5be-4afe95be8433" />
